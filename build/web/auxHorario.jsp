...
<html>
    ...
    <body>
                ...
                <div id="contenidoEncabezado" class="row">
                    ...
                    <form class="form-inline">
                        ...
                        <select class="form-control form-control-sm custom-select" id="v2" data-live-search="true">
                            <option  value="060336496-9">Escuela de Informática</option>
                        ...
                        <select class="form-control form-control-sm custom-select"  id="v3">
                            <option value="P0027">Informática</option>
                        ...
                        <select class="form-control form-control-sm custom-select"  id="v4">
                            ...
                            <option value="IS24185">Programación O O</option>
                        ...
                        <div id="menuLateral">
                            ...
                            <ul id="treeview">
                                ...
                                <li id="mnuSilabo" data-expanded="true">S&iacute;labo
                                    <ul>
                                        <li>
                                            <a class="nav-link" id="DatosGenerales" onclick="clickHorario1(); return false;">
                                                1. Datos generales
                                        ...
                                        <li>
                                            <a class="nav-link" id="DatosCalendario" onclick="">
                                                6. Datos de Docentes
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="row">
                            <div id="contenidoDinamicoScrollbar" class="col-xs-12">
                                <div id="contenidoDinamico" class="mt-1">
                                    <center>INGRESO DE CALENDARIO ACADÉMICO</center>
        ...
        <script src="./js/calendario.js" type="text/javascript"></script>
         <script src="./js/horario1.js" type="text/javascript"></script>
    </body>
