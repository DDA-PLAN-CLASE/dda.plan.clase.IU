...
<html lang="es">
    ...
    <body>
                        ...
                        <div id="menuLateral">
                            ...
                            <ul id="treeview">
                                ...
                                <li id="mnuSilabo" data-expanded="true">S&iacute;labo
                                    <ul>
                                        <li>
                                            <a class="nav-link" id="DatosGenerales" onclick="clickReporteCalendario(); return false;">
                                                1. Datos generales
                                            </a> 
                                        </li>
        ...
        <script src="./js/Calendario2.js" type="text/javascript"></script>
    </body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3>DDA-PLANIFICACIÓN DE ASIGNATURA</h3>
                </div>
