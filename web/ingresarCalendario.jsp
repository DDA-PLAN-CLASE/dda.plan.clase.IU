<%-- 
    Document   : ingresarCalendario
    Created on : 23/02/2017, 20:18:12
    Author     : Cristian
--%>
...
<html>
    ...
    <body>
                        ...
                        <div id="menuLateral">
                            ...
                            <ul id="treeview">
                                ...
                                <li id="mnuSilabo" data-expanded="true">S&iacute;labo
                                    <ul>
                                        <li>
                                            <a class="nav-link" id="DatosGenerales" onclick="clickCalendario();
                                                    return false;">
                                                1. Datos generales
                                            </a> 
                                        </li>
                                        ...
                                        <li>
                                            <a class="nav-link" id="DatosCalendario" onclick="clickCalendario('10', '20', '30', '40', '50', '60', '70');
                                                    return false;">
                                                6. Datos de Docentes
                                            </a>
                                        </li>
                        ...
                        <div class="row">
                            <div id="contenidoDinamicoScrollbar" class="col-xs-12">
                                <div id="contenidoDinamico" class="mt-1">
                                    <center><h3><b>INGRESO DE CALENDARIO ACADÉMICO</b></h3></center>
                                            <label class="col-xs-3 col-form-label">Fecha Inicio:</label><div class="col-xs-9"><input class="form-control" data-container="body" id="v1" type="date"></div>
                                            <label class="col-xs-3 col-form-label">Fecha Fin:</label><div class="col-xs-9"><input class="form-control" data-container="body" id="v2" type="date"></div>
                                            <label class="col-xs-3 col-form-label">Hora Inicio:</label><div class="col-xs-9"><input class="form-control" data-container="body" id="v3" type="time"></div>
                                            <label class="col-xs-3 col-form-label">Hora Fin:</label><div class="col-xs-9"><input class="form-control" data-container="body" id="v4" type="time"></div>
                                            <label class="col-xs-3">Motivo:</label><div class="col-xs-9"><input class="form-control" data-container="body" id="v5" type="text"></div>
                                            <label class="col-xs-3">Tipo:</label>
                                                    <div class="col-xs-9">
                                                        <select class="form-control" data-container="body" id="v8" size="1">
                                                        <option value="Feriado">Feriado</option>
                                                        <option value="Entrega de Notas">Entrega de Notas</option>
                                                        <option value="Otros">Otros</option>
                                                    </select>
                                                    </div>
                                            <label class="col-xs-3 col-form-label">Archivo:</label>
                                    <center><input type="hidden" id="v6" name="txtRutaC" value="<%=request.getAttribute("rutaFichero")%>">
                                        <form method="post" enctype='multipart/form-data' action="./SubirArchivo"  name="form1" >
                                            <div class="col-xs-9"><input type="file" name="fichero" /></div>
                                            <br/><br/>
                                        </form></center>
                                    <center><input type="button" value="Ingresar" onclick="clickCalendario1();
                                            return false;"></center>
                                </div>
                            </div>
                        </div>
        ...
        <script src="./js/calendario1.js" type="text/javascript"></script>
